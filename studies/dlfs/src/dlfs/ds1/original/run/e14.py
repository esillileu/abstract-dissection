    ...
    with source_imports(worktree):
        ...
        for name in ("W1", "b1", "W2", "b2"):
            ...
            metric_rows.extend(
                (
                    {
                        "metric": f"gradient_check/{name}/mean_absolute_difference",
                        "value": row["mean_absolute_difference"],
                    },
                    {
                        "metric": f"gradient_check/{name}/max_absolute_difference",
                        "value": row["max_absolute_difference"],
                    },
                )
            )
