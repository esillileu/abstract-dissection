...
from mlprosection.nn.layers import Affine, BatchNormalization, Dropout, Layer

from ..common import activation, initialize_affine
from ..sequential import Sequential


def MLP(*, input_size: int, hidden_sizes: Sequence[int], output_size: int, initializer: str = "he", activation_name: str = "relu", batchnorm: bool = False, dropout_ratio: float = 0.0) -> Sequential:
    layers: list[Layer] = []
