"""Seed-aware MLflow aggregation for deepscratch2 experiment figures."""
...
ANALYSIS_ROOT = Path("experiments/deepscratch2/results/analysis")
DEFAULT_TRACKING_URI = "http://127.0.0.1:5000"
DEFAULT_MLFLOW_EXPERIMENT = "deepscratch2"
