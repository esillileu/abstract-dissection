"""Run the declared deepbase2 sequence-model matrix."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run deepbase2 YAML experiment matrix.")
    ...
    print(f"deepbase2: {len(plans)} planned runs")
    if not args.dry_run:
