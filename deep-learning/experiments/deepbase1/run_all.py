"""Run the declared deepbase1 experiment matrix from its YAML catalog."""
...
CONFIG_ROOT = Path("experiments/deepbase1/config")


def main() -> None:
    parser = argparse.ArgumentParser(description="Run deepbase1 YAML experiment matrix.")
    ...
    print(f"deepbase1: {len(plans)} planned runs")
    if not args.dry_run:
