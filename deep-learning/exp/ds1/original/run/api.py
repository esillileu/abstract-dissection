"""Cache-aware DS1 original trial execution."""
...
from exp.original.cache import cache_is_valid, publish_result, stable_hash, staging_directory
from exp.original.worktree import clean_worktree, head_commit, source_hashes
...
def trials_for(experiments: list[str]) -> list[tuple[str, Trial]]:
    ...
    for experiment in experiments:
        module = importlib.import_module(f"exp.ds1.original.run.{experiment}")
