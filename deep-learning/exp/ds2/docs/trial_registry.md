...
| `dlfs2.ch05.ptb-small-rnnlm.custom-loop` | [`ch05/train_custom_loop.py`](../../../01_deep-learning-from-base/deep-learning-from-scratch-2/ch05/train_custom_loop.py); 위와 같은 모델·data·hyperparameter의 custom loop | epoch마다 평균 NLL에서 계산한 train PPL을 `ppl_list`·콘솔에 기록 |
