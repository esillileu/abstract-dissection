...
from exp.deepscratch.profile import (
    MeasurementProtocol,
    ProfilePoint,
    ProfileStudyResult,
    ScalingAxis,
)
from exp.deepscratch.profile.engine import measure_update_workload
...
def _measure_point(
    ...
    *,
    ...
    return ProfilePoint(
        ...
        metrics={
            **measured.metrics,
            "dense_parameter_optimizer_bytes": (
                8 * vocabulary_size * 100 * 4
            ),
        },
