...
from exp.deepscratch.profile import ProfileSection
...
def build_update_workload(
    ...
    adapter = UpdateWorkloadAdapter(
        workload, backend=backend, batch_size=batch_size
    )
    source = {
        "corpus": corpus,
        "contexts": contexts,
