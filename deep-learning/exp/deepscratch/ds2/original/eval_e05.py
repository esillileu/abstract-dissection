...
from exp.deepscratch.ds2.original.run.e05 import evaluate_pretrained
...
def main() -> None:
    ...
    parser.add_argument("--device", default="cuda:0", help="cpu or a CUDA device such as cuda:0")
