...
def measure_update_workload(
    ...
    *,
    ...
    try:
        ...
        timing = result.event_timing if protocol.timing_source == "event" else result.timing
        interval = _confidence_interval_95(timing.mean_ms, timing.stdev_ms, timing.count)
        return ProfilePoint(
