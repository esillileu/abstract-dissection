"""Typer callbacks for the promoted DS2 original-source domain."""
...
DEFINITION = DomainDefinition(name="ds2_original", config_root=Path("exp/ds2_original/config"), spec_module="exp.ds2_original.spec", executor_module="exp.ds2_original.executor", analysis_module="exp.ds2_original.analyze.render")
