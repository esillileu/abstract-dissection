...
from .layers import Relu, Sigmoid, Affine, SoftmaxWithLoss, BatchNormalization, Dropout
from b1.func import num_grad
    ...
    def num_grad(self, X, T):
        ...
        for idx in range(1, self.hidden_layer_num + 2):
            ...
            if self.use_batchnorm and idx != self.hidden_layer_num + 1:
                grads["gamma" + str(idx)] = num_grad(
                    loss_W, self.params["gamma" + str(idx)]
                )
                grads["beta" + str(idx)] = num_grad(
