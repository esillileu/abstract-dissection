...
from repro_core.context.progress import ProgressReporter
    ...
    context = ExperimentContext(
        ...
        metadata={
            ...
            **(
                ...
                else {"progress_reporter": progress_reporter}
            ),
        },
    )
    with runtime:
        ...
        result.metrics.update(
            build_schema_metrics(
                ...
                completed_epochs=int(
                    result.metrics.get("final/system/completed_epochs", 0)
                ),
        ...
        metric_rows = [
            *result.metric_rows,
            *build_profiling_metric_rows(result.profiling_metrics),
        ]
