"""Runtime reproducibility controls for deepscratch."""
...
def configure_runtime(
...
) -> tuple[Backend, SeedStreams, dict[str, object]]:
    ...
    backend = make_backend(
        BackendConfig(device=device, dtype=dtype, seed=streams.model_init)
    )
