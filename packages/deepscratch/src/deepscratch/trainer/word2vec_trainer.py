...
from deepscratch.trainer.events import EpochEvent, SourceObjectiveSample, UpdateEvent
    ...
    def fit(self, contexts: Tensor, targets: Tensor) -> None:
        ...
        try:
            for epoch_index in range(self.epoch, self.max_epochs):
                ...
                for local_iteration, (batch_x, batch_t) in enumerate(
                    self._iter_batches(shuffled_contexts, shuffled_targets)
                ):
