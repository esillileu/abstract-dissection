...
from deepscratch.nn.layers import Affine, Conv2D, Flatten, MaxPool2D, Relu
    ...
    def __init__(
        ...
        *,
        ...
        if conv_size <= 0 or conv_size % 2:
            raise ValueError(
                "convolution output must be positive and divisible by pooling size"
            )
