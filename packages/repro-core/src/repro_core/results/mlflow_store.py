...
class MlflowResultStore:
    ...
    def load(
        ...
        *,
        ...
        tags = run.data.tags
        schema_version = tags.get(
            "result.schema.version", tags.get("schema.version", "0")
        )
        try:
        ...
        return NativeRunResult(
            ...
            schema_name=tags.get(
                "result.schema.name", tags.get("schema.version", "legacy")
            ),
            ...
            provenance_ref=tags.get("provenance.ref")
            or tags.get("transfer.source.run_id"),
        )
